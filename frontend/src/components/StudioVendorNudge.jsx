...
const COPY = {
  ...
  vendor_hook:
    "When you partner with Birthright, you get the same Studio for your own products — list with our reach, or refer customers to your own store and earn referral credit.",
