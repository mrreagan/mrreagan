              ...
              {userMenu && (
                ...
                >
                  <Link
                    ...
                    className="block px-4 py-3 text-sm hover:bg-[#FAF8F5]"
                  ...
                  <Link
                    to="/profile"
                    onClick={() => setUserMenu(false)}
                    className="block px-4 py-3 text-sm hover:bg-[#FAF8F5] border-t border-[#E5E1D8]"
          ...
          <div className="container-page py-3 flex flex-col">
            ...
            {!user && (
              <div className="flex gap-2 pt-4">
                <Link to="/login" onClick={() => setOpen(false)} className="btn-outline flex-1 justify-center">
                  Sign in
                </Link>
      ...
      <div className="container-page py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/workshops" className="text-[#1A2424] hover:text-[#476B6B]">Workshops</Link></li>
            <li><Link to="/shop" className="text-[#1A2424] hover:text-[#476B6B]">Shop</Link></li>
            <li><Link to="/facilitators" className="text-[#1A2424] hover:text-[#476B6B]">Facilitators</Link></li>
            <li><Link to="/sponsorship" className="text-[#1A2424] hover:text-[#476B6B]">Sponsorship</Link></li>
          </ul>
        </div>
        <div>
          <p className="label mb-4">Foundation</p>
          <ul className="space-y-2 text-sm">
            <li><Link to="/about" className="text-[#1A2424] hover:text-[#476B6B]">About</Link></li>
            <li><Link to="/mission" className="text-[#1A2424] hover:text-[#476B6B]">Mission</Link></li>
            <li><Link to="/education" className="text-[#1A2424] hover:text-[#476B6B]">Education</Link></li>
            <li><Link to="/governance" className="text-[#1A2424] hover:text-[#476B6B]">Governance</Link></li>
            <li><Link to="/contact" className="text-[#1A2424] hover:text-[#476B6B]">Contact</Link></li>
          </ul>
        </div>
      </div>
