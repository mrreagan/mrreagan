  ...
  return (
    <div className="container-page py-24" data-testid="mission-page">
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto" data-testid="mission-pillars">
        {[
          { title: "Empower everyone", body: "Not the few who can already afford it, not only those already in therapy. Everyone. The tools belong to all of us." },
          { title: "Practical tools", body: "What you can use in the next conversation, with the next person, in the next hour. We don't teach theory for its own sake." },
          { title: "Real support", body: "A community that holds you between trainings. Facilitators who answer. Materials that travel with you." },
        ].map((p, i) => (
          <div key={i} className="card p-7" data-testid={`mission-pillar-${i}`}>
