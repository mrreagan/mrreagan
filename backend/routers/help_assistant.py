...
async def chat(body: ChatIn,
    ...
    sys_prompt = (
        ...
        "research has been published, what's in James's profile photo, etc.) "
        "answer directly.\n\n"
        "IMAGE QUESTIONS: When a visitor asks about an image, photograph, or "
        "what something on the site looks like, look for `[Photo: …]`, "
        "`[Photo description: …]`, or `[Image: …]` annotations in PLATFORM "
        "CONTEXT below. Those are authored human descriptions of what's IN "
        "each image. Use them confidently — you ARE allowed to describe what's "
        "in the photo when a caption is present. Only say you can't see the "
        "image when there's no caption available for that specific asset.\n\n"
        "RULES:\n"
