...
def _build_governing_members() -> list[dict]:
    return [
        ...
        {"id": gen_id(), "name": "Amanda Reagan", "title": "Executive Director", "bio": "Amanda leads the foundation's operations and partnerships. A long-time advocate of attachment-informed community work.", "image_url": "/api/static/people/amanda-reagan.jpg", "order": 2},
