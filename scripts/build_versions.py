...
IN_PROGRESS = [
    ("Phase 6C.2 + 6C.3", "Ombudsman queue + Disputes workflow",
     "Build a dedicated /admin/ombudsman queue surfacing flagged DM threads + a Disputes workflow tied to transactions (filing form, status pills open→under_review→resolved/dismissed, optional financial credit linkage prep for Step 10 clawback)."),
